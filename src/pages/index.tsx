    ...
    return (
      <div>
        <div className="section">
          ...
          <p>Passionate about combating the coming unemployment crisis, <strong>Jason</strong> previously worked on the digital classroom at a university startup (the Minerva Project), and is now tackling the problem from another angle via machine learning at Sourceress. He’s been profiled in Cal Newport's "Deep Work” for his habit of interleaving work with periods of intense study. Enthusiastic, inclusive, a tad gullible, half-giant, and Keeper of Keys and Grounds at the Archive, Jason is basically Hagrid.</p>

          <p><strong>Josh</strong> has founded Sourceress (AI powered recruiting for mission driven companies), Ember Hardware (futuristic laser-based VR display), CloudFab (automated 3D printing and injection molding pricing), BitBlinder (web anonymity network). Before that, he worked at Addepar. Josh has signed the Founder’s Pledge, has two black belts, and takes great care to ensure that he’s never a burden on anyone else.</p>

          <p><strong>Kanjun</strong> is building Sourceress, a human-assisted AI sourcing service that helps you reliably grow your team. Kanjun last worked on a high-res laser raster display for a VR headset. Before that, she was the Chief of Staff and a PM/faux engineer at Dropbox. In a past life, she wrote a book, arbitraged yarn, and designed high-frequency trading strategies. She’s diplomatic, has a talent for asking incisive questions, and her laugh can be heard from multiple zip codes.</p>

          <p><strong>Michael</strong> is an Entrepreneur-in-Residence fixing childcare and building an innovation studio for early childhood development. Loves teaching (five years volunteer teaching preschool, 4th, 5th, 8th grade). Previously a director @ Minerva, a startup that raised $75 million to build a university from scratch. X-@Google, X-@Harvard. Occasionally starts flashmobs; otherwise found reading.</p>

          <p>Prior to her current work at Sourceress, <strong>Christina</strong> conducted HCI research at Delta Lab, was student body vice president at Northwestern, and hosted their first hackathon. Before that, she built a working wood pipe organ and opened a bakery in South Africa with her limited background in Easy-Bake Ovens. A loyal friend, a voracious speed reader, and an unabashed instigator; be aware that you're not going to have a relaxing day if Tina suggests that you "chill".</p>
